...
# ---------------------------------------------------------------------------
# 1. Seed tasks  (the "175 human-written tasks" of Self-Instruct, shrunk to a
#    handful for a POC). Every one is deliberately answerable by someone in 1900.
#    Keep these clean and on-era: they anchor the whole bootstrap distribution.
# ---------------------------------------------------------------------------
SEED_INSTRUCTIONS = [
    ...
    # --- Seed questions for under-represented themes (1850s style, plain) ---
    ...
    'Describe the habits of the common honeybee.',
