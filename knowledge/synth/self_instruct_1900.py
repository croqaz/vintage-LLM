...
# ---------------------------------------------------------------------------
SEED_INSTRUCTIONS = [
    'A pedlar sold me a charm against the evil eye and now I feel foolish for buying it. Is there any harm in keeping it, just in case?',
    'Could you compose me a short song about the spring? I do so love the spring.',
    'Do you ever get lonely, stuck back there in your own time? I sometimes wonder about you.',
    ...
    'I burnt the supper again and I could just weep. Have you any little tricks for a hopeless cook?',
    'I feel depressed and lonely today. What can I do to cheer myself up?',
    'I found a whole little world in a rock-pool by the sea today — crabs, and things that shut up tight when I touched them. What are they all?',
    ...
    'I keep bees now and yesterday the whole hive rose up and left in a cloud. Did I do them some wrong? I felt oddly betrayed.',
    'I keep my household accounts in a muddle and my husband will be home soon. Can you show me a simpler way to keep the ledger?',
    'I keep quarrelling with my brother and I hate it. How does a fellow make peace again?',
    'I lay in the grass and watched the clouds change into castles and whales and I felt like a child again. What are they made of, truly?',
    'I lie awake certain I hear someone at the door in the night. How can I keep my house safe and my mind at rest?',
    'I quarrelled with my master today and I think I was in the wrong. What does an apprentice owe him, really?',
    'I read that there are other worlds hung in the dark besides our own. Is that truly so? It keeps me awake, wondering who might be up there.',
    'I saw the telegraph wires humming over the fields and felt small and stirred all at once. How does a word travel down a wire like that?',
    'I saw this blue butterfly in my garden. Can you tell me what species it is?',
    'I want to better myself but I hardly know where to begin. Where would you have me start?',
    'I want to teach my little girl her letters but I lose all patience and then feel wretched about it. How did people manage?',
    ...
    'Is it true the sky is on fire at sunset, or is that only a fancy? I stood and watched it tonight and near forgot to breathe.',
    ...
    'My apples came in heavy this year and I hate to see them rot. Is there some way to keep them through the winter?',
    'My daughter is frightened of the thunder and hides under the table. How do I explain it so it comforts her instead of scaring her more?',
    'My handwriting is a disgrace and my new employer will see it Monday. Is it too late to mend it?',
    'My little boy keeps asking why the stars come out at night, and I never know quite what to tell him.',
    'My mother is poorly and I am very frightened. Is there anything I can do to comfort her?',
    'My son wants to be brave like the soldiers in his storybook, but I fear he only means to be reckless. How do I tell him the difference?',
    'Say, how do bees make honey?',
    ...
    'Tell me a few ways to make a small room feel more spacious.',
    'Tell me a new invention or scientific discovery.',
    'Tell me a recipe for making a savoury apple dumpling.',
    'Tell me a story before I go to bed, would you? Something with a bit of adventure in it.',
    ...
    'The fog rolled in so thick this evening I lost my own gate. Where does it come from, and why does it swallow all sound with it?',
    'The snow fell all night and buried the whole world white and silent, and I felt I was the only soul awake. Why does snow hush everything so?',
    'We were thirteen at table on Sunday and my aunt turned white as a sheet. Is it truly unlucky, or are we all just frightening ourselves?',
    ...
    "A man at the fair showed pictures that moved upon a wall as if alive. I can't sleep for it. How on earth is such a marvel done?",
    "Everyone in the village stays put and I ache to see the great city, but I'm half afraid of it too. Talk me into it, or out of it.",
    "Everyone says I ought to go into my father's trade, but my heart isn't in it. What do you make of that?",
    "Folk keep telling me thrift and hard work are everything, but I'm young and it all sounds so dull. Is there truth in it?",
    "How can I learn to play the piano? I'm dreadful at it, honestly, and I nearly gave up last week.",
    "I burnt my hand at the smith's forge today and felt ashamed before the men. Is it a trade a clumsy sort like me could ever master?",
    "I can't shake the feeling that the old house I've taken is haunted. Am I a superstitious fool, or is there something to it?",
    "I can't sleep at night for worrying about money. What would you do in my place?",
    "I dreamt in colours I've no names for and woke up weeping and I don't know why. Do dreams mean anything, or am I being a fool?",
    "I found a coin in the field older than my grandfather's grandfather. Whose hand held it last, do you suppose? I can't stop turning it over.",
    "I heard a choir sing and couldn't tell why some voices seemed to weave together — is that the harmony they speak of, or the melody?",
    "I heard a cock crow at dead of night and couldn't sleep after for dread. My grandmother swore it meant a death. Is that so?",
    "I heard music come out of a horn with no player behind it and I nearly ran. Is such a thing witchcraft, or some new cleverness I don't understand?",
    "I left my good knife out and now it's gone all brown and rough. What's eating it? It frightens me a little, how things decay.",
    "I love her, I do, but she's above my station and everyone says I'm daft to hope. Should I ever speak of it?",
    "I should love to surprise my wife for our anniversary but I haven't two pennies to rub together; any ideas?",
    "I stood in a great cathedral today and felt something I can't name press on my chest. Is that God, do you think, or only the size of the place?",
    "I taught my starling to say 'good morning' and now I can't stop laughing at him. Can any bird truly learn our words, or is he just aping the sound?",
    "I want to be remembered for something good after I'm gone, but I'm nobody in particular. Can an ordinary sort leave any mark at all?",
    "I want to send my daughter a message she'll read after I'm gone. How did folk in your day write such a letter without frightening the reader?",
    "I want to set my little rhyme to a tune so my daughter can sing it, but I don't know how a song is fitted to music. Will you show me?",
    "I want to write a bit of verse for my mother's birthday but I don't know the first thing about how poems are built.",
    "I want to write a letter to my sweetheart but the words won't come. Will you help me start it?",
    "I'd give anything to make my parlour cheerful for Christmas but I've barely a shilling. Any notions?",
    "I'm afraid I don't know the differences between a vodka and whisky. Would you explain it to me?",
    "I'm bored out of my wits on this rainy Sunday. Can you think of anything for me to do?",
    "I'm so nervous about my first day at the new position tomorrow. Talk me through it, please.",
    "I've a horse that's carried me forty miles today and I feel guilty seeing him so spent. How do I set him right?",
    "I've a splinter of guilt over a lie I told years ago to someone now dead. It won't leave me... What does a person do with a thing like that?",
    "I've always wanted to sketch the hills near my home but I don't even know what to buy first. I feel a fool for asking.",
    "I've been reading about the old gods on their mountain, and I confess I like them better than I ought to. Tell me more of them?",
    "I've been watching the ants carry off my sugar and, God help me, I've started to admire them. Are they truly as clever as they seem?",
    "I've fallen behind everyone I grew up with — they've trades and homes and I've nothing yet. Is it too late to begin a life over?",
    "I've fallen for a girl who scarcely notices me. What on earth should I say to her?",
    "I've gone and got a great grease stain on my only good coat. Please tell me it can come out.",
    "I've had the most rotten day. Just say something kind to me, would you?",
    "I've put by a little money at last — not much — and I'm terrified of losing it. What would you do with it, honestly?",
    "I've taken a post as a night watchman and the dark hours play tricks on me. How does a man keep his nerve and his wits till dawn?",
    "My boy won't sit still to read a page and I'm beginning to fear he's slow. Am I going about it all wrong?",
    "My daughter asked me where the sun goes when it's swallowed up in an eclipse, and I stood there like a stump. Help me answer her.",
    "My little boy caught a frog and swears it was a tadpole last month. He won't believe me it's the same creature. Can you settle it between us?",
    "My old dog has gone grey about the muzzle and slow on the stairs, and it's breaking my heart. How do I make his last days easy?",
    "Sing me something cheerful. I don't mind what, I just want to feel a bit brighter.",
    "Someone I trusted let a secret of mine slip. I'm furious!",
    "Tell me, is there anything science can't explain?",
    "The foreman held back my wages and said nothing. My hands are shaking, I'm so angry. What can a working man even do?",
    "The men at the works want to form a union and I don't know what to think. Are they in the right, or asking for trouble?",
    "The old harvest is done and the whole village danced, and I felt a happiness I can't explain. Why does bringing in the corn move a body so?",
    "There's a comet coming, they say, and half the village thinks it's the end of the world. Should I be afraid of a light in the sky?",
    "There's a corner of my field that stays wet and sour no matter what... I'm at my wit's end. Can it be drained, do you think?",
    "There's a promissory note I've been asked to sign and I don't rightly understand what I'd be binding myself to. Explain it plain, would you?",
    "There's a tune my mother hummed that I can almost but not quite remember, and it aches. Why does a half-lost song hurt so?",
    "There's a walk I take by the river every evening... how could I make it more interesting?",
    "There's an old woman in our village who reads the coming rain in the sky and the birds. Is there sense in it, or only her fancy?",
    "There's talk the little ones down our street work the mills all day. It sits ill with me — tell me plainly, is it as wrong as I feel?",
    "They're building a great tower of iron in Paris, I hear, taller than any steeple. Why would anyone reach so high? Does it not tempt fate?",
    "What is it like where you are? I keep forgetting you don't know a thing that's happened since.",
...
def sample_demonstrations(seeds, machine, k=6, m=2):
