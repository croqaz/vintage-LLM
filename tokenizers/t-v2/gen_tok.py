...
# dataset texts are created from joining Oxford-archive, Time-Capsule and 500 Guttenberg books
tokenizer.train(['data/dataset-text.txt', 'data/dataset-text2.txt', 'data/dataset-text3.txt'], trainer)
